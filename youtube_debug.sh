...
DESTINATION_URL="https://www.youtube.com/tv?env_isVideoInfoVisible&nsp;1&env_forceFullAnimation&nsp;1&launch=${LAUNCH_TYPE}${DIAL_PARAMS}&additionalDataUrl=..."
...
# 300 MB
#export MEMORY_LIMIT=314572800

exec ./run_opera.sh simple_gles -u "$DESTINATION_URL" --user-agent="$USER_AGENT" --show-fps-counter --log-level=warning --remote-debugging-port=9222 $@
